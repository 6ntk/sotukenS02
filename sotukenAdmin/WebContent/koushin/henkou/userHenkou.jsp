...
<table id="table1" class="table01">
	...
	<c:forEach items="${km.uList}" var="item">
		...
		<tr id="tr2">
		<td style="width:50%"><a href="/sotukenAdmin/KoushinServlet?page=userHenkou&gakuseki=${item.gakuseki }">${item.gakuseki }</a></td>
		<td style="width:50%"><a href="/sotukenAdmin/KoushinServlet?page=userHenkou&gakuseki=${item.gakuseki }">${item.name }</a></td>
	</tr>
