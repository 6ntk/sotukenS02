...
<form action="/sotukenAdmin/TempServlet" method="post" id="myform" name="myform">
	...
	<table id="studentInfo" class="table1">
		...
		<tr >
			...
			<th>出席番号</th>
			<td><a href="/sotukenAdmin/TempServlet?page=userHenkou">${tm.ui.syuNum}</a></td>
	...
	<table id="table1" class="table1">
		...
		<tr >
			...
			<th>企業名</th>
			<td><a href="/sotukenAdmin/TempServlet?page=kigyoHenkou">${tm.ki.kigyoName}</a></td>
		</tr>
		<tr>
			<th>住所</th>
			<td>${tm.ki.address}</td>
